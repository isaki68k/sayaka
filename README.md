twitter クライアント sayaka ちゃん version 3.1.0 (2015/07/26)
======
...
---
* sixel 対応ターミナル。
mlterm など sixel 対応のターミナルが必要です
(ただし RLogin は sixel 画像を勝手にリサイズするので非推奨)。
kterm など sixel に対応していないターミナルでは `--noimg` オプションを
使用することにより文字だけでの表示はできます。
